...
fig4 = px.scatter(employee_data_aux, x='average_work_hours', y='performance_score', 
                  color='gender', title='Horas promedio trabajadas vs desempeño')
st.write(fig4)
...
# streamlit run "C:\Users\Jorge\Desktop\Data Scientist\Semana 15-16\Streamlit\reto_C4SC4.py"